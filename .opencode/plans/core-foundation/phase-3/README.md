...
| 3.4 | `@repo/generator` + Vue tenant Pinion generator  | [`3.4-generator.md`](./3.4-generator.md)                   | ✅ COMPLETED                                                                                             |
| 3.5 | Turborepo pipeline update                        | [`3.5-turbo-pipeline.md`](./3.5-turbo-pipeline.md)         | ✅ COMPLETED                                                                                             |
| 3.6 | Documentation updates                            | [`3.6-documentation.md`](./3.6-documentation.md)           | ✅ COMPLETED                                                                                             |

## Cross-cutting

- Each deliverable ends with **Manual Confirmation** — human verifies before next starts
- Order is strict (3.1 → 3.2 → 3.3 → 3.4 → 3.5 → 3.6)
- C validates the layer mechanism end-to-end before D (generator) is built
