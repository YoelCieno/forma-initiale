...
- [ ] `mkdir -p apps/fake-plants-vue/src/{components,pages,styles}`
...
- [ ] Create `apps/fake-plants-vue/src/styles/tokens.css`:
  ```css
...
- [ ] Create `apps/fake-plants-vue/src/components/ProductCard.vue`:
...
- [ ] Create `apps/fake-plants-vue/src/pages/AboutPage.vue` (new tenant-specific page)
...
- [ ] Product cards show plant icons
