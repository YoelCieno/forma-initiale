...
| 4.4 | Angular base components (fe-* compositing, CUSTOM_ELEMENTS_SCHEMA) | [`4.4-base-components.md`](./4.4-base-components.md) | ✅ COMPLETED |
| 4.4.6 | Shared @repo/utils package (util unification) | [4.4-base-components.md](./4.4-base-components.md) | ✅ COMPLETED |
